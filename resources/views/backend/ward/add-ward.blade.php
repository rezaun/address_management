                            ...
                            <div class="card-header">
                                <h3>
                                    ...
                                    @else
                                        Add Ward
                                    @endif
                                    <a class="btn btn-success float-right" href="{{route('wards.view')}}"><i class="fa fa-list"> Ward List</i></a>
                                </h3>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <form method="POST" action="{{(@$editData)?route('wards.update', $editData->id):route('wards.store')}}">
                                    @csrf
                                    <div class="card-body">
